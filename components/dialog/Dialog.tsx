...
import { Dialog as DialogExample, Transition } from '@headlessui/react';
      ...
      >
        <div className='flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
          <Transition.Child
            ...
            leaveTo='opacity-0'
          >
            <DialogExample.Overlay className='fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity' />
          </Transition.Child>
